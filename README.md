...
![SpeechRecognition](https://img.shields.io/badge/SpeechRecognition-2DD4BF?style=flat-square)
![pyttsx3](https://img.shields.io/badge/pyttsx3_TTS-7C6CFF?style=flat-square)
...
```
> 🔑 Set your **OpenAI API key** and **weather API key** in the notebook before running.
